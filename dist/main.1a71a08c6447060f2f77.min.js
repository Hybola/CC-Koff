(() => {
  ...
  class t {
    ...
    getInputs() {
      return [
        ...
        this.shippingInput.value,
      ];
    }
    showPrice(t) {
      this.resultBox.innerText = t;
    }
    onClick(t) {
      this.totalBtn.addEventListener("click", t);
    }
  }
  ...
  class r {
    ...
    showErrorMessage = (t, r) => {
      const s = t.reduce(
        (t, s, n) => (e(r[n]) ? (t += "") : (t += `${s} is not a number. `), t),
        ""
      );
      (this.errorBox.innerText = s), this.showError();
    };
  }
  (() => {
    const s = new t(),
    ...
    n.hideError(),
      s.onClick(() => {
        n.hideError();
        const t = s.getInputs(),
          r = ((...t) => t.map((t) => Number(t)))(...t);
        if (e(...r)) {
          const [t, e, n] = r,
            i = t * e + n;
          s.showPrice(i);
        } else n.showErrorMessage(t, r);
      });
  })();
})();
